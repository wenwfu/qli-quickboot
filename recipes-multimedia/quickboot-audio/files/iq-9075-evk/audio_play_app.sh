...
# This bash script servers as the early playback app. It uses
# pw-play to send the chime to a specific low-latency speaker-sink.
#
# Critically, it echoes its status directly inro the kernel ring
...
SERVICE_NAME="quickboot_audio_play_app.service"
...
START_TIME=$(date +%s.%N)
# Execue playback. Any stdout/err from pw-play is parsed and logged to both
